...
<div class="container"> 
<fieldset> 
<legend>파일업로드하기</legend>
<c:url value="upfile" var="upproc"></c:url>
<form action="${upproc}" method="post" enctype="multipart/form-data">
<div class="form-group"> 
                    <label for="name">제목</label> 
                    <input type="text" class="form-control" size="10" name="i_title"> 
                </div> 
                <div class="form-group"> 
                    <label for="name">파일</label> 
                    <input type="file" name="i_file" required="required"> 
                </div>
